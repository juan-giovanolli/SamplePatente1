...
public class FineAdapter extends BaseAdapter {
    ...
    public FineAdapter(Vector list, Activity activity) {
        super();
        this.list = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        Fine elem = (Fine) list.elementAt(position);
        LayoutInflater inflater = activity.getLayoutInflater();
        View view = inflater.inflate(R.layout.activity_fine_item, null, true);
